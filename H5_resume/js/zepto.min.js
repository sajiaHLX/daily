var Zepto = function () {
    ...
    function U(c, d, e) {
        for (b in d) e && (K(d[b]) || E(d[b])) ? (K(d[b]) && !K(c[b]) && (c[b] = {}), E(d[b]) && !E(c[b]) && (c[b] = []), U(c[b], d[b], e)) : d[b] !== a && (c[b] = d[b])
    }
    ...
    return z.matches = function (a, b) {
        var c, d, e, f;
        return b && a && 1 === a.nodeType ? (c = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.matchesSelector) ? c.call(a, b) : (e = a.parentNode, f = !e, f && (e = C).appendChild(a), d = ~z.qsa(e, b).indexOf(a), f && C.removeChild(a), d) : !1
    }, A = function (a) {
        ...
        var f, g, j;
        return n.test(b) && (f = c(i.createElement(RegExp.$1))), f || (b.replace && (b = b.replace(o, "<$1></$2>")), d === a && (d = m.test(b) && RegExp.$1), d in v || (d = "*"), j = v[d], j.innerHTML = "" + b, f = c.each(h.call(j.childNodes), function () {
            j.removeChild(this)
        ...
        if (!b) return z.Z();
        if ("string" == typeof b)
            if (b = b.trim(), "<" == b[0] && m.test(b)) e = z.fragment(b, RegExp.$1, d), b = null;
            else {
            ...
            else if (m.test(b)) e = z.fragment(b.trim(), RegExp.$1, d), b = null;
            else {
                if (d !== a) return c(d).find(b);
                e = z.qsa(i, b)
            }
...
! function (a) {
    ...
    function j(a, b) {
        var c, d, e, h;
        return a = a.replace(/=#\]/g, '="#"]'), e = g.exec(a), e && e[2] in f && (c = f[e[2]], d = e[3], a = e[1], d && (h = Number(d), d = isNaN(h) ? d.replace(/^["']|["']$/g, "") : h)), b(a, c, d)
    }
    var b = a.zepto,
        c = b.qsa,
        d = b.matches,
...
! function (a) {
    ...
    h.click = h.mousedown = h.mouseup = h.mousemove = "MouseEvents", a.event = {
        ...
        var c, d, e;
        if (f(a) || (b = a, a = b.type), c = document.createEvent(h[a] || "Events"), d = !0, b)
...
! function (a) {
    ...
    function q(a, b) {
        var c = b.context;
        return b.beforeSend.call(c, a, b) === !1 || n(b, c, "ajaxBeforeSend", [a, b]) === !1 ? !1 : (n(b, c, "ajaxSend", [a, b]), void 0)
    }

    function r(a, b, c, d) {
        var e = c.context,
            f = "success";
        c.success.call(e, a, f, b), d && d.resolveWith(e, [a, f, b]), n(c, e, "ajaxSuccess", [b, c, a]), t(f, b, c)
    }

    function s(a, b, c, d, e) {
        var f = d.context;
        d.error.call(f, c, b, a), e && e.rejectWith(f, [c, b, a]), n(d, f, "ajaxError", [c, d, a || b]), t(b, c, d)
    }
    ...
    l.href = window.location.href, a.active = 0, a.ajaxJSONP = function (d, e) {
        ...
        var h, i, j, m, C, n, p, t, z, A, B, D, f = a.extend({}, b || {}),
            g = a.Deferred && a.Deferred();
        for (d in a.ajaxSettings) void 0 === f[d] && (f[d] = a.ajaxSettings[d]);
        if (o(f), f.crossDomain || (h = c.createElement("a"), h.href = f.url, h.href = h.href, f.crossDomain = l.protocol + "//" + l.host != h.protocol + "//" + h.host), f.url || (f.url = window.location.toString()), (i = f.url.indexOf("#")) > -1 && (f.url = f.url.slice(0, i)), y(f), j = f.dataType, m = /\?.+=\?/.test(f.url), m && (j = "jsonp"), f.cache !== !1 && (b && b.cache === !0 || "script" != j && "jsonp" != j) || (f.url = x(f.url, "_=" + Date.now())), "jsonp" == j) return m || (f.url = x(f.url, f.jsonp ? f.jsonp + "=?" : f.jsonp === !1 ? "" : "callback=?")), a.ajaxJSONP(f, g);
        if (n = f.accepts[j], p = {}, t = function (a, b) {
                p[a.toLowerCase()] = [a, b]
            }, z = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : window.location.protocol, A = f.xhr(), B = A.setRequestHeader, g && g.promise(A), f.crossDomain || t("X-Requested-With", "XMLHttpRequest"), t("Accept", n || "*/*"), (n = f.mimeType || n) && (n.indexOf(",") > -1 && (n = n.split(",", 2)[0]), A.overrideMimeType && A.overrideMimeType(n)), (f.contentType || f.contentType !== !1 && f.data && "GET" != f.type.toUpperCase()) && t("Content-Type", f.contentType || "application/x-www-form-urlencoded"), f.headers)
            for (e in f.headers) t(e, f.headers[e]);
        if (A.setRequestHeader = t, A.onreadystatechange = function () {
                if (4 == A.readyState) {
                    ...
                    if (A.status >= 200 && A.status < 300 || 304 == A.status || 0 == A.status && "file:" == z) {
                        if (j = j || w(f.mimeType || A.getResponseHeader("content-type")), "arraybuffer" == A.responseType || "blob" == A.responseType) b = A.response;
                        else {
                            b = A.responseText;
                            try {
        ...
        if (D = "async" in f ? f.async : !0, A.open(f.type, f.url, D, f.username, f.password), f.xhrFields)
            for (e in f.xhrFields) A[e] = f.xhrFields[e];
...
! function (a) {
                    ...
                    return c(function (c) {
                        a.each(d, function (d, e) {
                            ...
                            g[e[1]](function () {
                                ...
                                b && a.isFunction(b.promise) ? b.promise().done(c.resolve).fail(c.reject).progress(c.notify) : (d = this === f ? c.promise() : this, g = h ? [b] : arguments, c[e[0] + "With"](d, g))
                            })
                        }), b = null
                    }).promise()
                },
    ...
    a.when = function (d) {
        ...
        if (f > 1)
            for (j = new Array(f), k = new Array(f), l = new Array(f); f > g; ++g) e[g] && a.isFunction(e[g].promise) ? e[g].promise().done(m(g, l, e)).fail(i.reject).progress(m(g, k, j)) : --h;
...
! function (a, b) {
    ...
    f.style.transform === b && a.each(e, function (a, e) {
    ...
    }), h = c + "transform", q[i = c + "transition-property"] = q[j = c + "transition-duration"] = q[l = c + "transition-delay"] = q[k = c + "transition-timing-function"] = q[m = c + "animation-name"] = q[n = c + "animation-duration"] = q[p = c + "animation-delay"] = q[o = c + "animation-timing-function"] = "", a.fx = {
        ...
        var t, v, y, u = {},
            ...
            A = !1;
        if (d === b && (d = a.fx.speeds._default / 1e3), s === b && (s = 0), a.fx.off && (d = 0), "string" == typeof c) u[m] = c, u[n] = d + "s", u[p] = s + "s", u[o] = e || "linear", z = a.fx.animationEnd;
        else {
            v = [];
            for (t in c) g.test(t) ? w += t + "(" + c[t] + ") " : (u[t] = c[t], v.push(r(t)));
            w && (u[h] = w, v.push(h)), d > 0 && "object" == typeof c && (u[i] = v.join(", "), u[j] = d + "s", u[l] = s + "s", u[k] = e || "linear")
        }
        return y = function (b) {
...
! function (a) {
    ...
    if (a.os.ios) {
        ...
        a(document).bind("gesturestart", function (a) {
            var e = Date.now();
            e - (b.last || e), b.target = d(a.target), c && clearTimeout(c), b.e1 = a.scale, b.last = e
    ...
    a(document).ready(function () {
        ...
        "MSGesture" in window && (h = new MSGesture, h.target = document.body), a(document).bind("MSGestureEnd", function (a) {
            ...
            (!(t = n(f, "up")) || m(f)) && (k(), b.x2 && Math.abs(b.x1 - b.x2) > 30 || b.y2 && Math.abs(b.y1 - b.y2) > 30 ? e = setTimeout(function () {
                ...
                var d = a.Event("tap");
                d.cancelTouch = l, b.el && b.el.trigger(d), b.isDoubleTap ? (b.el && b.el.trigger("doubleTap"), b = {}) : c = setTimeout(function () {
